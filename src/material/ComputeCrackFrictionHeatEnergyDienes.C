...
registerMooseObject("HeatConductionApp", ComputeCrackFrictionHeatEnergyDienes);

InputParameters
ComputeCrackFrictionHeatEnergyDienes::validParams()
{
...
ComputeCrackFrictionHeatEnergyDienes::computeQpProperties()
{
  ...
  if ( _crack_normal_norm[_qp] > 8.0e-9/_l ) {
